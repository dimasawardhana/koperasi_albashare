			...
			?>
				<table class="table table-stiped table-bordered table-hover ">
					<thead>
						...
						if(isset($tarekah_a)){
						switch($tarekah_a[0]->waktu){
						
						case '3':{echo"<th>Akad 3 Bulan</th>";break;}
						
						case '6':{echo"<th>Akad 6 Bulan</th>";break;}
						
						case '12':{echo"<th>Akad 12 Bulan</th>";break;}
						}
						}
						?>
						</tr>
					...
					<tbody>
						...
						case '3':{echo"<th>40:60</th>";break;}
						
						case '6':{echo"<th>50:50</th>";break;}
						
						case '12':{echo"<th>60:40</th>";break;}
							}
						}
						?>
						...
						if(isset($tarekah_a))
						{
							...
							echo "<th>Anggota</th>";
							switch($tarekah_a[0]->waktu){
							case '3':{echo "<th>".$tarekah_a[0]->awal/12*40/100 ."%</th>";break;}
							case '6':{echo "<th>".$tarekah_a[0]->awal/12*50/100 ."%</th>";break;}
							case '12':{echo "<th>".$tarekah_a[0]->awal/12*60/100 ."%</th>";break;}
							}
							echo "</tr>";
							...
							switch($tarekah_a[0]->waktu){
							case '3':{echo "<th>".$tarekah_a[0]->awal/12*60/100 ."%</th>";break;}
							case '6':{echo "<th>".$tarekah_a[0]->awal/12*50/100 ."%</th>";break;}
							case '12':{echo "<th>".$tarekah_a[0]->awal/12*40/100 ."%</th>";break;}
							}
							echo "</tr>";
							...
							switch($tarekah_a[0]->waktu){
							case '3':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal) *3/12 ."</th>";break;}
							case '6':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal) *6/12 ."</th>";break;}
							case '12':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal) ."</th>";break;}
							}
							...
							echo "<th>Anggota</th>";
							switch($tarekah_a[0]->waktu){
							case '3':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal) *3/12*40/100 ."</th>";break;}
							case '6':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal) *6/12*50/100 ."</th>";break;}
							case '12':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal)*60/100 ."</th>";break;}
							}
							echo "</tr>";
							...
							echo "<th>Albashare</th>";
							switch($tarekah_a[0]->waktu){
							case '3':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal) *3/12*60/100 ."</th>";break;}
							case '6':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal) *6/12*50/100 ."</th>";break;}
							case '12':{echo "<th>".($tarekah_a[0]->bagihasil - $tarekah_a[0]->awal)*40/100 ."</th>";break;}
							}
