							...
							<tbody>
								...
								?>
											...
											<tr>
												...
												<td>
												<div class="btn-group">
                        						<a href="<?php echo base_url();?>anggota/detail_anggota/<?php echo $object->id?>" class="btn btn-primary btn-sm">Detail</a>
                        						<?php if($object->cabang!=0){ ?>
												<a href="<?php echo base_url();?>anggota/edit/<?php echo $object->id?>" class="btn btn-primary btn-sm">Edit</a>
											<?php	}?>
											</div>
                        </td>
												<td><?php echo $object->nama;?></td>
<td><?php
if($object->cabang == 1){echo "BDG"; }
else if($object->cabang == 2){echo "CLG"; }
else if($object->cabang == 3){echo "SRG"; }
?> 
