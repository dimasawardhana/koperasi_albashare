          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select id="pilihan" name="pilihan" class ="form-control col-sm-3" >
               ...
               <option value="2">Pembiayaan Mudhorobah</option>
              </select>
            </div>
          </div>
          ...
          function getContent(parents,valuePilihan){
            switch(valuePilihan){
                case '1':{
                  ...
                  teks = "<label name='lblktr' id='lblmargin' class='control-label col-md-2'></label>";
                  //append to div
                  ...
                  var node1 = document.createElement("div");
                  node1.classList.add('form-group');
                  text1 = "<label name='nom_Label' id='lblNominal' class ='control-label col-md-2'> Harga Jual</label>";
                  // add input text
                  text2 = "<div class='col-sm-6'><input type='text' id='harga_jual' name='harga_jual' class='form-control' onkeyup='shownominal();showcicilan();'/></div>";
                  ...
                  var node1 = document.createElement("div");
                  node1.classList.add('form-group');
                  text1 = "<label name='lblktr' id='lblktr' class='control-label col-md-2'>Dicicil sebanyak</label>";
                  // add input text
                  text2 = "<div class='col-sm-2'><input type='number' name='cicilanbulan' id='cicilanbulan' class='form-control' min='3' max='12' value = '3' onchange='showcicilan();shownominal();' /></div>";
                  teks = "<label name='lblktr' id='lblktr' class='control-label col-sm-1'>Bulan</label>"
                  //append to div
                  node1.innerHTML = text1 + text2 + teks;
                  ...
                  text1 = "<label name='nom_Label' id='lblnominal' class ='control-label col-md-2'>cicilan per-bulan</label>";
                ...
                case '2':{
                  ...
                  var text1 = "<label name='lblktr' id='lblktr' class='control-label col-md-2'> Nama Usaha</label>";
                  var text2 = "<div class='col-sm-6'><input type='text' name='nama_usaha' id='nama_usaha' class='form-control' maxlength='255'/></div>";
                  var teks = "";
                  node.innerHTML = text1 + text2 + teks;
                  parents.appendChild(node);
                  ...
                  // add label
                  text1 = "<label name='nom_Label' id='lblNominal' class ='control-label col-md-2'> Pembiayaan</label>";
                  // add input text
                  text2 = "<div class='col-sm-6'><input type='number' name='pembiayaan' id='pembiayaan' class = 'form-control' onchange='cekAllFilled(1);' onkeyup='shownominal()' step ='1000'/></div>";
                  teks = "<label name='lblktr' id='lblmargin' class='control-label col-md-2'></label>";
                  //append to div
                  node1.innerHTML = text1 + text2 + teks;
                  ...
                  text1 = "<label name='lblktr' id='lblktr' class='control-label col-md-2'>Dicicil sebanyak</label>";
                  // add input text
                  text2 = "<div class='col-sm-2'><input type='number' name='bulan' id='bulan' class='form-control' min='3' max='12' value = '3' onchange='showcicilan();shownominal();' /></div>";
                  teks = "<label name='lblktr' id='lblktr' class='control-label col-sm-1'>Bulan</label>"
                  //append to div
                  node1.innerHTML = text1 + text2 + teks;
                  ...
                  node2.classList.add('form-group');
                  text1 = "<label name='nom_Label' id='lblnominal' class ='control-label col-md-2'>cicilan per-bulan</label>";
                  text2 = "<div class='col-sm-6'><input type='number' name='cicilanbulan' id='cicilanbulan' class = 'form-control' onchange='cekAllFilled(2)' onkeyup='shownominal()' step='1000'/></div>";
                  teks = "<label name='nom_Label' id='error3' class ='control-label col-md-2'></label>";
                  node2.innerHTML = text1+text2+teks;
                  parents.appendChild(node2);
                  ...
                  text2 = "<div class='col-sm-6'><input type='text' name='ktr' id='keterangan' class='form-control' maxlength='50'/></div>";
                  node3.innerHTML = text1+text2;
                  parents.appendChild(node3);

                  var nodeSubmit = document.createElement("div");
                  nodeSubmit.classList.add('form-group');
                  text3 = "<div class='col-sm-offset-3 col-sm-10'><button type='submit' class='btn btn-primary' id='submitButton' >Submit</button>   <button type='reset' class='btn btn-danger'>Cancel</button>   </div>";
                  nodeSubmit.innerHTML = text3;
                  parents.appendChild(nodeSubmit);
